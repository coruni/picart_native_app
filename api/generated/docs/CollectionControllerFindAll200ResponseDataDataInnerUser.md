# CollectionControllerFindAll200ResponseDataDataInnerUser
...
```typescript
import { CollectionControllerFindAll200ResponseDataDataInnerUser } from './api';

const instance: CollectionControllerFindAll200ResponseDataDataInnerUser = {
    id,
    username,
    nickname,
    status,
