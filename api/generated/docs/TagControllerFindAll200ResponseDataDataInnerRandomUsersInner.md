# TagControllerFindAll200ResponseDataDataInnerRandomUsersInner
...
**banned** | **string** |  | [default to undefined]
...
**equippedDecorations** | [**CommentControllerFindAll200ResponseDataDataInnerRepliesInnerParentAuthorEquippedDecorations**](CommentControllerFindAll200ResponseDataDataInnerRepliesInnerParentAuthorEquippedDecorations.md) |  | [optional] [default to undefined]

## Example

```typescript
import { TagControllerFindAll200ResponseDataDataInnerRandomUsersInner } from './api';

const instance: TagControllerFindAll200ResponseDataDataInnerRandomUsersInner = {
    id,
    username,
    nickname,
    status,
