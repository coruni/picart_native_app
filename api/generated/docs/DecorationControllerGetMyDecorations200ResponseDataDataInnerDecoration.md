# DecorationControllerGetMyDecorations200ResponseDataDataInnerDecoration
...
```typescript
import { DecorationControllerGetMyDecorations200ResponseDataDataInnerDecoration } from './api';

const instance: DecorationControllerGetMyDecorations200ResponseDataDataInnerDecoration = {
    id,
    name,
    type,
    description,
