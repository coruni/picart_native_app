# ArticleControllerUpdate200ResponseDataDataCategoryParent
...
```typescript
import { ArticleControllerUpdate200ResponseDataDataCategoryParent } from './api';

const instance: ArticleControllerUpdate200ResponseDataDataCategoryParent = {
    id,
    name,
    description,
    parentId,
