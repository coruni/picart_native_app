# CommentControllerFindAllComments200ResponseDataDataInnerAuthor
...
```typescript
import { CommentControllerFindAllComments200ResponseDataDataInnerAuthor } from './api';

const instance: CommentControllerFindAllComments200ResponseDataDataInnerAuthor = {
    id,
    username,
    nickname,
    status,
