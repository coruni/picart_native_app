...
**decorationId** | **number** | 奖励装饰品ID | [optional] [default to undefined]
...
**isPermanent** | **boolean** | 奖励是否永久 | [optional] [default to undefined]
...
```typescript
import { UpdateActivityDto } from './api';

const instance: UpdateActivityDto = {
    name,
    description,
    type,
    decorationId,
