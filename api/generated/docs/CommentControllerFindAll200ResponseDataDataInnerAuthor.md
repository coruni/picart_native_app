# CommentControllerFindAll200ResponseDataDataInnerAuthor
...
```typescript
import { CommentControllerFindAll200ResponseDataDataInnerAuthor } from './api';

const instance: CommentControllerFindAll200ResponseDataDataInnerAuthor = {
    id,
    username,
    nickname,
    status,
