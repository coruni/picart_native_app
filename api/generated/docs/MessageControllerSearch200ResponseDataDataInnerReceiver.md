# MessageControllerSearch200ResponseDataDataInnerReceiver
...
```typescript
import { MessageControllerSearch200ResponseDataDataInnerReceiver } from './api';

const instance: MessageControllerSearch200ResponseDataDataInnerReceiver = {
    id,
    username,
    nickname,
    status,
