...
------------ | ------------- | ------------- | -------------
**code** | **string** | 活动代码 | [default to undefined]
...
**rewardPoints** | **number** | 奖励积分 | [default to undefined]
...
```typescript
import { CreatePointsActivityDto } from './api';

const instance: CreatePointsActivityDto = {
    code,
    name,
    description,
    type,
