# ArticleControllerGetDislikedArticles200ResponseDataDataInnerAuthor
...
**equippedDecorations** | [**ArticleControllerGetDislikedArticles200ResponseDataDataInnerAuthorEquippedDecorations**](ArticleControllerGetDislikedArticles200ResponseDataDataInnerAuthorEquippedDecorations.md) |  | [default to undefined]
...
```typescript
import { ArticleControllerGetDislikedArticles200ResponseDataDataInnerAuthor } from './api';

const instance: ArticleControllerGetDislikedArticles200ResponseDataDataInnerAuthor = {
    id,
    username,
    nickname,
    status,
