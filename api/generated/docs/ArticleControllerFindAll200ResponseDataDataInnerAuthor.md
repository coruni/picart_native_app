# ArticleControllerFindAll200ResponseDataDataInnerAuthor
...
```typescript
import { ArticleControllerFindAll200ResponseDataDataInnerAuthor } from './api';

const instance: ArticleControllerFindAll200ResponseDataDataInnerAuthor = {
    id,
    username,
    nickname,
    status,
