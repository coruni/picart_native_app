# DecorationControllerGetUserDecorations200ResponseDataDataInnerDecoration
...
```typescript
import { DecorationControllerGetUserDecorations200ResponseDataDataInnerDecoration } from './api';

const instance: DecorationControllerGetUserDecorations200ResponseDataDataInnerDecoration = {
    id,
    name,
    type,
    description,
